"""strix-cross-file agent: cross-file vulnerability correlation analysis.

Launched by AgentManager as a subprocess. Reads task JSON from stdin,
runs cross-file analysis, writes result JSON to stdout.
"""
...
def _setup_logging(workspace: Path | None = None) -> None:
    ...
    try:
        ...
        log_file = workspace / "cross_file.log" if workspace else None
